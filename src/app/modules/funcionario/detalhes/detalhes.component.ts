...
export class DetalhesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.funcionarioForm = this.formBuilder.group({
      ...
      cargo: [funcionario.cargo, [Validators.required, Validators.minLength(6)]],
      horasSemanais: [funcionario.horasSemanais, [Validators.required, Validators.min(0)]],
      salario: [funcionario.salario, [Validators.required, Validators.pattern(/^\d*\.?\d*$/), Validators.min(0)]],
